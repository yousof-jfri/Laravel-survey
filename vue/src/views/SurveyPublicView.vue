<template>
    <div class="py-5 px-8">
        ...
        <form v-else @submit.prevent="submitSurvey" class="container mx-auto">
            ...
            <div v-if="surveyFinished" class="py-8 px-6 bg-green-400 text-white w-[600px] mx-auto">
...
<script setup>
    ...
    function submitSurvey(){
        store.dispatch("saveSurveyAnswer", {surveyId : survey.value.id, answers : answers.value })
            .then(res => {
                if(res.status === 201){
